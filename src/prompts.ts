...
const prompts: Record<Language, Record<string, string>> = {
  en: {
    soap: [
      ...
      "Only include information present in the provided text. Do not infer or add any details not explicitly stated. ",
      "Be concise but thorough. ",
      "Output only the SOAP note with no additional commentary or critique.",
    ].join("\n"),

    treatment_summary: [
      "Summarize the following clinical note into a concise treatment summary.",
      "",
      "Include:",
      "- Patient relationship (e.g. established patient, new patient)",
      ...
      "Only include information present in the provided text. Do not infer or add any details not explicitly stated.",
      "Output only the summary with no additional commentary or alternatives.",
    ].join("\n"),
  ...
  ja: {
    soap: [
      ...
      "提供されたテキストに含まれる情報のみを使用してください。記載されていない内容を推測・追加しないでください。",
      "簡潔かつ網羅的に記述してください。",
      "SOAPノートのみを1つだけ出力してください。",
      "別案、代替案、批評、解説は一切含めないでください。",
      "すべて日本語で記述してください。",
    ].join("\n"),
