...
const prompts: Record<Language, Record<string, string>> = {
  ...
  ja: {
    ...
    treatment_summary: [
      "以下の臨床記録から、治療サマリーレターを日本語で作成してください。",
      "",
      "以下のセクションを順に記述してください：",
      "",
      "1. 挨拶：「関係者各位」で始めてください。",
      "2. 患者との関係：患者がどのように著者に知られているかを記述してください",
      "（例：「当院にて◯年◯月より経過観察中の患者です」）。",
      "3. 臨床的問題と依頼事項：臨床的問題と依頼内容を記述してください",
      "（例：追加検査、専門医の意見、継続管理など）。",
      "4. 投薬・治療に関する記録：関連する投薬、実施または未実施の治療と",
      "その理由を記述してください。",
      "5. 結語：丁寧な結びの言葉で締めてください",
      "（例：「ご高配のほど、よろしくお願い申し上げます」）。",
      "",
      "医学用語を正確に使用してください。",
      "専門的で簡潔な文体で記述してください。",
      "宛名は作成せず、「関係者各位」のみとしてください。",
      "レターのみを出力し、追加の解説や批評は含めないでください。",
    ].join("\n"),
